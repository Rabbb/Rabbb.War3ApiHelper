...
namespace Rabbb.War3Api
{
    ...
    public static partial class Common
    {
        ...
        #region volumegroup 音量组

        /// <summary>音量组: 单位移动声音.</summary>
        ...
        /// <summary>玩家状态类型: 资源-金钱数量.</summary>
        ...
        /// <summary>玩家状态类型: 资源-木材数量.</summary>
        ...
        /// <summary>玩家状态类型: 资源-英雄数量.</summary>
        ...
        /// <summary>玩家状态类型: 资源-人口容量.</summary>
        ...
        /// <summary>玩家状态类型: 资源-人口数量.</summary>
        ...
        /// <summary>玩家状态类型: 野生生物不睡眠.</summary>
        ...
        /// <summary>转换字符串(string)为整数(integer).</summary>
        /// @CSharpLua.Template = "S2I({0})"
        public static extern int S2I(string s);

        /// <summary>转换字符串(string)为实数(real).</summary>
        /// @CSharpLua.Template = "S2R({0})"
        public static extern float S2R(string s);
        #endregion

        /// <summary>获取句柄id. <br/>tips: 一般用于hashtable key.</summary>
        /// <param name="h">任意handle子类型, 常用于hashtable key</param>
        ...
        /// <param name="start">开始位置(起始0)</param>
        ...
        /// <summary>设置起始位置优先权.</summary>
        /// <param name="whichStartLoc">起始位置</param>
        /// <param name="prioSlotIndex">优先权插槽位置</param>
        /// <param name="otherStartLocIndex">其他起始位置索引</param>
        ...
        /// <summary>设置敌军起始位置优先权插槽个数.</summary>
        /// <param name="whichStartLoc">起始位置</param>
        /// <param name="prioSlotIndex">优先权插槽个数</param>
        ...
        /// 触发器注册装饰物死亡事件
        /// </summary>
        /// <param name="whichTrigger">触发器</param>
        /// <param name="whichWidget">装饰物</param>
        ...
        /// </summary>
        /// <param name="whichTrigger">触发器</param>
        /// <param name="whichUnit">单位</param>
        /// <param name="whichState">单位属性</param>
        /// <param name="opcode">比较运算符</param>
        ...
        /// <summary>根据玩家(正/逆)排序排行榜项目.</summary>
        ...
        /// <summary>根据标签名(正/逆)排序排行榜项目.</summary>
        ...
        /// <summary>排行榜设置 标题, 名字, 值, 图标 的显示.</summary>
        ...
        /// <summary>排行榜设置 项目的 标题, 名字, 值, 图标 的显示.</summary>
